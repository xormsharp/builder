...
[![GitCI.cn](https://gitci.cn/api/badges/xormsharp/builder/status.svg)](https://gitci.cn/xormsharp/builder)  [![codecov](https://codecov.io/gh/xormsharp/builder/branch/master/graph/badge.svg)](https://codecov.io/gh/xormsharp/builder)
[![](https://goreportcard.com/badge/github.com/xormsharp/builder)](https://goreportcard.com/report/github.com/xormsharp/builder)

Package builder is a lightweight and fast SQL builder for Go and XORM.

Make sure you have installed Go 1.8+ and then:

    go get github.com/xormsharp/builder
